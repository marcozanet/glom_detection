...
def test_manager_detect_muw_sfog(): 
    ...
    src_root = '/Users/marco/helical_tests/test_yolo_detect_train_muw_sfog' if system == 'mac' else  r'D:\marco\datasets\slides'
    dst_root = '/Users/marco/helical_tests/test_yolo_detect_train_muw_sfog' if system == 'mac' else  r'D:\marco\datasets\slides'
    slide_format = 'tif'
    label_format = 'json'
