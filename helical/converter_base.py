...
class ConverterBase(Configurator):
    ...
    def __call__(self) -> None:
        ...
        # remove all files (annotations + slides) where the annotation doesn't exist or is empty
...
def test_Converter():
    ...
    converter = ConverterBase(folder = folder, 
                              level = 0,
