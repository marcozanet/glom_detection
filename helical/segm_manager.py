...
def test_ProcessorManager(): 
    ...
    # DEVELOPMENT 
    src_root = '/Users/marco/helical_tests/test_hubmap_segm_manager' if system == 'mac' else  r'D:\marco\hubmap_slides\detection'
    dst_root = '/Users/marco/helical_tests/test_hubmap_segm_manager' if system == 'mac' else  r'D:\marco\hubmap_slides\detection'
    slide_format = 'tif'
    label_format = 'json'
    split_ratio = [0.7, 0.15, 0.15]    
    data_source = 'hubmap'
