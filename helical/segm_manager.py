...
def test_ProcessorManager(): 
    ...
    # DEVELOPMENT 
    src_root = '/Users/marco/helical_tests/test_hubmap_segm_manager' if system == 'mac' else  r'D:\marco\datasets\slides'
    dst_root = '/Users/marco/helical_tests/test_hubmap_segm_manager' if system == 'mac' else  r'D:\marco\datasets\slides'
    slide_format = 'tif'
    label_format = 'json'
